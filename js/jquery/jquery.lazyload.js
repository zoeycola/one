                ...
                if (!this.loaded) {
                    ...
                    img.onload = function() {
                            ...
                            if ($self.is("img")) {
                                ...
                                //console.log('html:'+$self.html());
                                //$self[0].src=original;
                                //$self.html('<embed src="' + original + '" />')
                                //$("img.lazy")[0].src = 'https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superplus/img/logo_white.png';
                                //$self[0].setAttribute('src',original);
